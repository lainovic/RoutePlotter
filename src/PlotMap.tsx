      ...
      <div className="sidebar">
        ...
        <div className="highlighted-field">
          <div className="note">
            ...
            You can drag the points around. Press left click on the map to add a
            point. Press right click on the point to remove it.
            <br />
            ...
            route.
            <br />
            Press <span className="key">P</span> to enter the coordinates of a
            point and to add it to the route.
          </div>
        </div>
      </div>
    </div>
