...
export default function BrowseMap() {
  ...
  return (
    <>
      <h1>
        <Typewriter text="Hello, map" delay={100} infinite={false} />
      </h1>
      ...
      <div className="sidebar">
        <div className="highlighted-field">
          <div className="note">
            ...
            <div className="note-title">Loading route data</div>
            <ul>
              <li>
              ...
              <li>
                ...
                separated by white spaces. The latitude and longitude values
                need to be separated by a comma, or a space, or a combination of
                both. The following formats are accepted:
                <div
                  style={{
                    textAlign: "start",
                    display: "flex",
